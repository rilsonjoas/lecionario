...
export function ModeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-md border border-accent/30 bg-background/60 text-secondary backdrop-blur-sm transition-colors hover:bg-dourado/10 hover:text-accent"
    >
