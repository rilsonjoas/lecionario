  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-3 md:px-4 relative z-10">
        {/* Linha 1 (2026-08-22): marca à esquerda + tema à direita — no
            xs o botão de tema não flanava mais sozinho abaixo do logo */}
        ...
        {/* Date and Liturgical Info — some nas páginas institucionais:
            ...
            (apontamento do autor, 2026-08-22). O tema fica na linha 1. */}
        {!isMinimal && (
          <div className="md:text-right space-y-3 md:space-y-4 mt-4 md:mt-2">
            <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-1.5 md:py-2 bg-preto-ébano/30 backdrop-blur-md rounded-full border border-dourado/20">
            ...
            {/* Badges e HOJE na MESMA linha (refino do autor 2026-08-22):
                hierarquia limpa em vez de pilha de elementos soltos */}
            <div className="flex flex-wrap items-center justify-start md:justify-end gap-x-4 md:gap-x-6 gap-y-3 text-[9px] md:text-[10px] uppercase font-bold tracking-[0.25em] md:tracking-[0.3em] text-dourado-texto">
              ...
              {/* Cliente reativo: some sozinho quando a URL volta a ser
                  hoje; envolvido em Suspense por usar useSearchParams */}
