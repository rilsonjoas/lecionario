  ...
  theme: {
    ...
    extend: {
      transitionTimingFunction: {
        // Design Narniano — easing litúrgico (transição de página) e vela
        // (acender) — nunca bounce/spring. Ver Identidade Visual - Guia
        // Técnico no vault.
        liturgico: 'cubic-bezier(0.65, 0, 0.35, 1)',
        vela: 'cubic-bezier(0.16, 1, 0.3, 1)',
      },
      fontFamily: {
      ...
      colors: {
        ...
        'dourado-texto': 'hsl(var(--dourado-texto))',
        vinho: 'hsl(var(--vinho))',
      ...
      backgroundImage: {
        'liturgical-gradient':
          'linear-gradient(135deg, hsl(var(--liturgical-gradient-start)), hsl(var(--liturgical-gradient-end)))',
        'liturgical-radial':
          'radial-gradient(ellipse at center, hsl(var(--liturgical-gradient-start) / 0.1), hsl(var(--liturgical-gradient-end) / 0.05))',
      },
      boxShadow: {
