...
// Duplicado de propósito do lecionario-web/src/lib/pix.ts — os dois apps
// não compartilham pacote; manter em sincronia ao alterar.
//
// ⚠️ Dados finais confirmados pelo autor (2026-08-22): chave dedicada
// ao projeto cadastrada na conta pessoal dele. O campo 59 do padrão
// limita o nome a 25 caracteres — usamos a forma curta; na confirmação
// o banco exibe o nome completo do titular registrado de qualquer forma
// (o campo é cosmético, quem manda é o DICT). Racional completo no ROADMAP.
