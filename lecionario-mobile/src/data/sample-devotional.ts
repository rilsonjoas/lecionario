import type { Reading, DailyPrayer, MeditationResource } from '@/types';
...
export const samplePrayer: DailyPrayer = {
...
export const sampleMeditation: MeditationResource = {
  prompt:
    'João Batista nos chama a "preparar o caminho do Senhor". Em que áreas da sua vida você sente que precisa fazer essa preparação? Como você pode criar espaço em seu coração e mente para receber Cristo mais plenamente neste Advento?',
  questions: [
...
export const fallbackCollect =
  'Deus misericordioso, que enviaste os teus mensageiros, os profetas, para pregar o arrependimento e preparar o caminho para a nossa salvação: Concede-nos graça para dar ouvidos às suas advertências e abandonar os nossos pecados, para que possamos saudar com alegria a vinda de Jesus Cristo, nosso Redentor.';
